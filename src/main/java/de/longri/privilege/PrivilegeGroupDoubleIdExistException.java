 ...
 */
public class PrivilegeGroupDoubleIdExistException extends PrivilegeException {
    /**
     ...
     *
     * @param id the name of the duplicate privilege
     */
    public PrivilegeGroupDoubleIdExistException(int id) {
        super("the PRIVILEGE_GROUP with id " + id + " is exist");
    }
}
